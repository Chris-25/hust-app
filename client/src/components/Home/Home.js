        ...
        <Grid container justify="space-between" alignItems="stretch" spacing={3} className={classes.gridContainer}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AppBar className={classes.appBarSearch} position="static" color="inherit">
              <TextField onKeyDown={handleKeyPress} name="search" variant="outlined" label="Tìm kiếm bài đăng" fullWidth value={search} onChange={(e) => setSearch(e.target.value)} />
              <ChipInput
                style={{ margin: '10px 0' }}
                value={tags}
...
<FormControl fullWidth>
  ...
  >
    ...
    <MenuItem value={30}>Thirty</MenuItem>
              ...
              <Button onClick={searchPost} className={classes.searchButton} variant="contained" color="primary">Tìm kiếm</Button>
            </AppBar>
