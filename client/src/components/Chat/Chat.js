    ...
    useEffect(() => {
        let contact = async () => {
            if (currentUser) {
                ...
                setContacts(data.data.filter(user => user._id !== currentUser.result._id));
            }
        }
        contact();
    }, []);
                ...
                <Container>
                    <div className="container">
                        ...
                        {currentChat === undefined ? (
                                <div style={{"background":"white","textAlign":"center","alignContent":"center","paddingTop":"200px","fontSize":"30px", "borderRadius":"20px"}}>
